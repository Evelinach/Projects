...
class TestGoneFishing
{
	...
	void testGoneFishingButtonListener()
	{
		...
		FishingButtonListener listener = new FishingButtonListener(
				goneFishingModel, goneFishingView, fishingButton);
		...
		// There should be nine or ten schools of fish remaining depending on
		// whether we caught
		// anything.
		assertTrue(goneFishingModel.getFishRemaining() == 10
				|| goneFishingModel.getFishRemaining() == 9);
	}
